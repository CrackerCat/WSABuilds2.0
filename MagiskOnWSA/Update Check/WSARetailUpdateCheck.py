...
print("Files in '/home/runner/work/WSABuilds2.0/WSABuilds2.0/MagiskOnWSALocal1/xml':", os.listdir('/home/runner/work/WSABuilds2.0/WSABuilds2.0/MagiskOnWSALocal1/xml'))
...
if not new_version_found:
    # Get information
    with open("/home/runner/work/WSABuilds2.0/WSABuilds2.0/MagiskOnWSALocal1/xml/GetCookie.xml", "r") as f:
    ...
    with open("/home/runner/work/WSABuilds2.0/WSABuilds2.0/MagiskOnWSALocal1/xml/WUIDRequest.xml", "r") as f:
